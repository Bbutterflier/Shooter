...
public class vImportSettingsEditorWindow : EditorWindow
{
    ...
    GUISkin skin;
    Vector2 rect = new Vector2(380, 270);
    ...
    public void OnGUI()
    {
        ...
        EditorGUILayout.HelpBox("This Template requires a custom InputManager, Layers, Tags and a PhysicsManager.\n \n" +
            ...
            "We always recommend to import the Template into a New and Clean Project, using it as a base to build your game.\n \n" + 
            "You can uncheck the InputManager if you're using the FSM AI Template without Invector's ThirdPerson Template", MessageType.Warning, true);
